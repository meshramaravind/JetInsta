...
object DataDummy {
    ...
    val storyList = listOf(
        ...
        story.copy(
            ...
            storyImageId = R.drawable.food16,
            time = "11m"
        ),
        story.copy(
            id = 3,
        ...
        story.copy(
            ...
            storyImageId = R.drawable.food15,
            time = "11m"
        ),
        story.copy(
            id = 6,
        ...
        story.copy(
            ...
            handle = "@WeChat",
            authorImageId = R.drawable.p9,
            storyImageId = R.drawable.food10,
            time = "11m"
        ),
        story.copy(
            id = 8,
        ...
        story.copy(
            ...
            handle = "@Shazam",
            authorImageId = R.drawable.p8,
            storyImageId = R.drawable.food11,
            time = "11m"
        ),
        story.copy(
            id = 7,
            ...
            handle = "@Chrome",
            authorImageId = R.drawable.p9,
            storyImageId = R.drawable.food12,
            time = "11m"
        ),
        story.copy(
            id = 6,
            ...
            handle = "@Safari",
            authorImageId = R.drawable.p8,
            storyImageId = R.drawable.food13,
            time = "11m"
        ),
        story.copy(
            id = 7,
            ...
            handle = "@Disney",
            authorImageId = R.drawable.p9,
            storyImageId = R.drawable.food14,
            time = "11m"
        )
